...
#台灣進口能源國家比例
finalProj$BureauEnergy$data$Imp_EnergySource <- read_excel("./Tasks/Final Project/ImportEnergySource.xlsx")

#台灣對進口能源依賴比率
finalProj$BureauEnergy$data$Imp_EnergyRelience <- read_excel("./Tasks/Final Project/ImportEnergyRelience.xlsx")

#台灣能源總消費量
finalProj$BureauEnergy$data$Dom_Energy_Consumption <- read_excel("Tasks/Final Project/DomesticEnergyConsumption.xlsx", skip = 1)
...
View(finalProj$BureauEnergy$data$Dom_Energy_Consumption)
finalProj$BureauEnergy$data$Dom_Energy_Consumption$years|> as.Date()
```
