...
names(ReNew_World)[[1]] <- "Year"
names(Renew_Taiwan)[[1]] <- "Year"
names(ReNew_EU)[[1]] <- "Year"


a <- merge(x=ReNew_World, y=Renew_Taiwan, by= "Year")
finalProj$IEA$data$ReNew_EnCon <- merge(x=a, y=ReNew_EU, by= "Year")

finalProj$IEA$data$ReNew_EnCon <- select(finalProj$IEA$data$ReNew_EnCon, c(1,2,4,6))
names(finalProj$IEA$data$ReNew_EnCon)[[2]] <- "World"
names(finalProj$IEA$data$ReNew_EnCon)[[3]] <- "Taiwan"
names(finalProj$IEA$data$ReNew_EnCon)[[4]] <- "EU"
