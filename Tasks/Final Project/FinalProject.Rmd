...
finalProj$BureauEnergy$data$Imp_EnergySource |>
  ...
  mutate(
    source=paste("Imp_Source: ", finalProj$BureauEnergy$data$Imp_EnergySource$日期)
  ) -> .df2
```
...
##好像有可能是scale的問題，在limits的部份把部分應該顯現的資料給弄掉了?
```

```{r}
lineColor= c("black", "#4F4F4F", "#6C6C6C", "#E0E0E0","#D0D0D0", "#BEBEBE")
